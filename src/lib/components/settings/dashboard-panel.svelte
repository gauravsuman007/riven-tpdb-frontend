<script lang="ts">
    ...
    } from "$lib/dashboard.remote";

    /*
        The dashboard is a tab on the settings page rather than a page of its
        own, so its four streamed queries arrive as part of that page's data
        and are handed down here. `$lib/dashboard` states the shape, because
        a component under `$lib` cannot read a route's generated `./$types`.
    */
...
<div class="flex flex-col">
    <h1 class="mb-8 text-2xl font-bold tracking-tight">Media Library Statistics</h1>
