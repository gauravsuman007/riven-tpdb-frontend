<script lang="ts">
    ...
    onMount(() => {
        // Initialize as a discovery page for this media type
        searchStore.mediaType = mediaType;
                ...
                <div class="flex items-center gap-2">
                    ...
                    <Select.Root
                        ...
                        <Select.Content
                            ...
                            {#each SORT_OPTIONS.filter( (o) => (o.allowedFor as readonly string[]).includes(mediaType) ) as option (option.value)}
            ...
            <div
                ...
                {#each searchStore.results as item (`${item.id}-${item.indexer}`)}
                    <div class="aspect-[2/3] w-full">
                        <ListItem data={item} indexer={item.indexer} type={mediaType} />
                    </div>
                {/each}
